      ...
      <section className="pt-32 pb-20 px-6">
        <div className="max-w-4xl mx-auto">
          ...
          <ScrollAnimation delay={100}>
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-sm mb-16">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-green-500 focus:border-transparent"
                  />
                </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    required
                    rows="6"
                    className="w-full px-4 py-2 rounded-lg border border-gray-300 dark:border-gray-700 bg-white dark:bg-gray-800 focus:ring-2 focus:ring-green-500 focus:border-transparent resize-none"
                  />
                </div>
          ...
          <ScrollAnimation delay={200}>
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-sm mb-16">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-3">Creating Custom Timers</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">Starting, Pausing & Resetting Sessions</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-3">Viewing Your Statistics</h3>
                  <p className="text-gray-600 dark:text-gray-300">
          ...
          <ScrollAnimation delay={300}>
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-sm mb-16">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-2">Where are my stats?</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">How do I reset a session?</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">How do I customize my timer?</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Does it work in the background?</h3>
                  <p className="text-gray-600 dark:text-gray-300">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">How do streaks work?</h3>
                  <p className="text-gray-600 dark:text-gray-300">
          ...
          <ScrollAnimation delay={400}>
            <div className="bg-white dark:bg-gray-900 p-8 rounded-xl shadow-sm mb-16">
              ...
              <div className="space-y-6">
                <div>
                  <h3 className="text-xl font-semibold mb-2">Notifications not working</h3>
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">App not tracking progress</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
                ...
                <div>
                  <h3 className="text-xl font-semibold mb-2">Timer stopping in background</h3>
                  <p className="text-gray-600 dark:text-gray-300 mb-2">
