        ...
        <div className="max-w-4xl mx-auto">
          ...
          <ScrollAnimation delay={900}>
            <div className="bg-white p-8 rounded-xl shadow-sm mb-8">
              ...
              <p className="text-gray-600">
                Email: <a href="mailto:s.alaeiyeh@gmail.com" className="text-green-600 hover:underline">s.alaeiyeh@gmail.com</a>
              </p>
              <p className="text-gray-600 mt-4">
                Or use our <Link href={`/${locale}/pomofocus-support`} className="text-green-600 hover:underline">support page contact form</Link>.
              </p>
            </div>
          </ScrollAnimation>
